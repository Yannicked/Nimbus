...
pub struct AppState {
    ...
    pub grid_cache: DashMap<(Cow<'static, str>, i64), Arc<Vec<u16>>>,
    /// Key: (ens, time), value: PNG data image bytes
    pub data_cache: DashMap<(Cow<'static, str>, i64), Vec<u8>>,
    ...
    pub timeseries_cache: DashMap<(Cow<'static, str>, i32, i32), Arc<Vec<f64>>>,
}
