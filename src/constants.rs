...
// GRIB1 / Harmonie grid parameters
pub const GRIB_W: usize = 390;
pub const GRIB_H: usize = 390;
pub const GRIB_DX: f64 = 0.029;
pub const GRIB_DY: f64 = 0.018;
pub const GRIB_X0: f64 = 0.0;
pub const GRIB_Y0: f64 = 49.0;
